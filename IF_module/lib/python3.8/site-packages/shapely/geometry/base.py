...
def dump_coords(geom):
    ...
    if not isinstance(geom, BaseGeometry):
        ...
        return geom.z_coords[:]
    elif geom.geom_type == "Polygon":
        return geom.exterior.z_coords[:] + [i.z_coords[:] for i in geom.interiors]
...
class BaseGeometry(shapely.Geometry):
    ...
    def buffer(
        ...
        **kwargs,
        ...
        >>> g.buffer(1.0, 3).area
        3.0
        >>> list(g.buffer(1.0, cap_style=BufferCapStyle.square).exterior.z_coords)
